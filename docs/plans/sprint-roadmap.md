...
> **Completed**: sprint-M4-model-tier, sprint-M3-sprint-flow-automation, sprint-M2-platform-wrappers, sprint-M1-schema-foundation, v1.1.0-process-refactor, harness-sync, self-evolution-2
> **Pending**: —
