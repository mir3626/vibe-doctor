...
> **Completed**: sprint-M10-integration-release, sprint-M9-statusline-permissions, sprint-M8-audit-review-gaps, sprint-M7-phase0-seal-and-utilities, sprint-M6-pattern-shards, sprint-M5-native-interview, sprint-M4-model-tier, sprint-M3-sprint-flow-automation, sprint-M2-platform-wrappers, sprint-M1-schema-foundation, v1.1.0-process-refactor, harness-sync, self-evolution-2
> **Pending**: —
