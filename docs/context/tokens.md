...
- v1.7.7 adds one small consensus packet at the end of `/vibe-interview`. It should replace later rework rather than add another probing round; keep the summary compact and ask only for approve/revise/defer/proxy-unconfirmed.
