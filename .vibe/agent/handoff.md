...
## 2. Status: IDLE - Sprint sprint-M3-status-tick-windows-regression passed
...
| `sprint-M3-status-tick-windows-regression` | sprint-M3-status-tick-windows-regression | passed |
