...
- **repo**: `vibe-doctor`
- **branch**: `main`
- **working release**: `v1.7.5` (LTS baseline remains `v1.7.3-lts`)
...
Current mainline release is `v1.7.5`, pushed to `origin/main` at `8e87726`; tag `v1.7.5` is also pushed. LTS baseline remains immutable tag `v1.7.3-lts`.
