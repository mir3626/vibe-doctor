...
function parseArgs(argv) {
  ...
  if (!sprintId || !status || !['passed', 'failed'].includes(status)) {
    fail(
      'Usage: node .vibe/harness/scripts/vibe-sprint-commit.mjs <sprintId> <passed|failed> [--scope <glob,glob,...>] [--message <extra>] [--no-verify-gpg] [--push-tag] [--dry-run]',
    );
  }
...
// CROSS-REF (.vibe/harness/migrations/1.4.0.mjs:compareVersions)
