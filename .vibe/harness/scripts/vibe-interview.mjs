...
function usage() {
  return [
    'usage: node .vibe/harness/scripts/vibe-interview.mjs --init --prompt "<one-liner>" [--lang ko|en] [--max-rounds 30] [--mode init|iterate] [--carryover <iteration-id>] [--output <path>]',
