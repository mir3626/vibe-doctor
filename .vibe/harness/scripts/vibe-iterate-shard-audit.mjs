...
const REQUIRED_PHASES = [
  ...
  { id: 'phase-2-append-sprint-roadmap', pattern: /^#{1,2}\s+(?:vibe-iterate\s+)?Phase 2 - Append Sprint Roadmap\b/m },
...
const CRITICAL_SIGNALS = [
  ...
  { id: 'append-roadmap-section', pattern: /## Iteration iter-<N>/ },
  { id: 'never-overwrite-roadmap', pattern: /Never overwrite existing roadmap content/ },
