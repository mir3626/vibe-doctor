...
const sprintCompletePath = path.resolve('.vibe', 'harness', 'scripts', 'vibe-sprint-complete.mjs');
const auditClearPath = path.resolve('.vibe', 'harness', 'scripts', 'vibe-audit-clear.mjs');
