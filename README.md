...
자세한 릴리스 내역은 `docs/release/v1.2.0.md` ~ `v1.6.6.md` 참조.
...
```
Sync plan: vibe-doctor v1.5.17 -> 1.6.6
...
cat .vibe/config.json | grep harnessVersion    # "1.6.6" 출력
```
